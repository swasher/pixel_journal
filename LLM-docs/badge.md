...
To achive the functionality of the notification badge, use the sibling [`Indicator`](/LLM-docs/components/indicators) component. Remember to add the `relative` class to parent element.
